...
build_time_vars = {
    ...
    'BASECPPFLAGS': '',
    'BASEMODLIBS': '',
    'BINDIR': '/opt/_internal/cpython-3.13.1/bin',
    'BINLIBDEST': '/opt/_internal/cpython-3.13.1/lib/python3.13',
    ...
    'CONFIG_ARGS': "'CFLAGS_NODIST=-g -O2 -Wall -fdebug-prefix-map=/=. -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 ' 'LDFLAGS_NODIST=-Wl,-Bsymbolic-functions -Wl,-z,relro -Wl,-z,now' '--prefix=/opt/_internal/cpython-3.13.1' '--disable-shared' '--with-ensurepip=no' '--with-openssl=/opt/_internal/openssl-3.0' '--with-openssl-rpath=auto' 'PKG_CONFIG_PATH=/usr/local/lib/pkgconfig' 'TCLTK_LIBS=-ltk8.6 -ltcl8.6'",
    'CONFINCLUDEDIR': '/opt/_internal/cpython-3.13.1/include',
    'CONFINCLUDEPY': '/opt/_internal/cpython-3.13.1/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/Python-3.13.1/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/Python-3.13.1/lcov-report',
    'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage --title "CPython 3.13 LCOV report [commit $(shell )]"',
    'CPPFLAGS': '-I. -I./Include',
    'CXX': 'g++ -pthread',
    'DESTDIRS': '/opt/_internal/cpython-3.13.1 /opt/_internal/cpython-3.13.1/lib /opt/_internal/cpython-3.13.1/lib/python3.13 /opt/_internal/cpython-3.13.1/lib/python3.13/lib-dynload',
    'DESTLIB': '/opt/_internal/cpython-3.13.1/lib/python3.13',
    'DESTPATH': '',
    'DESTSHARED': '/opt/_internal/cpython-3.13.1/lib/python3.13/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/opt/_internal/cpython-3.13.1/bin/python3.13',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'INCLDIRSTOMAKE': '/opt/_internal/cpython-3.13.1/include /opt/_internal/cpython-3.13.1/include /opt/_internal/cpython-3.13.1/include/python3.13 /opt/_internal/cpython-3.13.1/include/python3.13',
    'INCLUDEDIR': '/opt/_internal/cpython-3.13.1/include',
    'INCLUDEPY': '/opt/_internal/cpython-3.13.1/include/python3.13',
    ...
    'LDVERSION': '3.13',
    'LIBC': '',
    'LIBDEST': '/opt/_internal/cpython-3.13.1/lib/python3.13',
    'LIBDIR': '/opt/_internal/cpython-3.13.1/lib',
    ...
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/opt/_internal/cpython-3.13.1/lib/pkgconfig',
    'LIBPL': '/opt/_internal/cpython-3.13.1/lib/python3.13/config-3.13-x86_64-linux-gnu',
    'LIBPYTHON': '',
    ...
    'MACHDEP': 'linux',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/opt/_internal/cpython-3.13.1/lib/python3.13',
    'MACOSX_DEPLOYMENT_TARGET': '',
    'MAJOR_IN_MKDEV': 0,
    'MAJOR_IN_SYSMACROS': 1,
    'MAKESETUP': './Modules/makesetup',
    'MANDIR': '/opt/_internal/cpython-3.13.1/share/man',
    'MIMALLOC_HEADERS': '\\',
    ...
    'MODULE__HASHLIB_CFLAGS': '-I/opt/_internal/openssl-3.0/include',
    'MODULE__HASHLIB_DEPS': './Modules/hashlib.h',
    'MODULE__HASHLIB_LDFLAGS': '-L/opt/_internal/openssl-3.0/lib  -Wl,--enable-new-dtags,-rpath=/opt/_internal/openssl-3.0/lib  -lcrypto',
    ...
    'MODULE__SQLITE3_LDFLAGS': '-Wl,--enable-new-dtags,-rpath=/usr/local/lib -L/usr/local/lib -lsqlite3',
    'MODULE__SQLITE3_STATE': 'yes',
    'MODULE__SRE_LDFLAGS': '',
    'MODULE__SSL_CFLAGS': '-I/opt/_internal/openssl-3.0/include',
    ...
    'MODULE__SSL_LDFLAGS': '-L/opt/_internal/openssl-3.0/lib  -Wl,--enable-new-dtags,-rpath=/opt/_internal/openssl-3.0/lib -lssl -lcrypto',
    ...
    'MODULE__TKINTER_LDFLAGS': '-ltk8.6 -ltcl8.6',
    ...
    'RETSIGTYPE': 'void',
    'RUNSHARED': '',
    'SCRIPTDIR': '/opt/_internal/cpython-3.13.1/lib',
    ...
    'VERSION': '3.13',
    'WASM_ASSETS_DIR': './opt/_internal/cpython-3.13.1',
    'WASM_STDLIB': './opt/_internal/cpython-3.13.1/lib/python3.13/os.py',
    'WHEEL_PKG_DIR': '',
    'WINDOW_HAS_FLAGS': 1,
    ...
    'abs_builddir': '/Python-3.13.1',
    'abs_srcdir': '/Python-3.13.1',
    'datarootdir': '/opt/_internal/cpython-3.13.1/share',
    'exec_prefix': '/opt/_internal/cpython-3.13.1',
    'prefix': '/opt/_internal/cpython-3.13.1',
    'srcdir': '.',
}
